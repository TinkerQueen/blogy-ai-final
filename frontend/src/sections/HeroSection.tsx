  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center pt-20 pb-10 overflow-hidden">
      ...
      <div className="container relative z-10 px-4 flex flex-col items-center text-center mt-10">
        ...
        {/* Animated Badge */}
        <Badge variant="outline" className="mb-8 px-4 py-1.5 border-indigo-500/30 bg-indigo-500/10 text-indigo-200 animate-fade-in backdrop-blur-sm shadow-[0_0_20px_rgba(99,102,241,0.2)]">
          <span className="flex items-center gap-2">
            🏆 <span>Winner — DTU Bizmark'26 Hackathon</span>
          </span>
        </Badge>
